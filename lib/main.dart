...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: UniversityTransportationDriver(
          title: 'University Transportation Driver'),
    );
  }
}

class UniversityTransportationDriver extends StatefulWidget {
  UniversityTransportationDriver({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _UniversityTransportationDriverState createState() =>
      _UniversityTransportationDriverState();
}

class _UniversityTransportationDriverState
    extends State<UniversityTransportationDriver> {
